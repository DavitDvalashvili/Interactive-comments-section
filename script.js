...
replyButtons.forEach((replyButton) => {
  ...
  replyButton.addEventListener("click", (event) => {
    ...
    if (!active.addCommentActive) {
      ...
      target.parentNode.parentNode.parentNode.insertAdjacentElement(
        "afterend",
        newReply
      );
...
function submitReply() {
  ...
  replyBox.querySelector(".submit").addEventListener("click", (event) => {
    if (event.target.previousElementSibling.value !== "") {
      ...
      reply.querySelector(".tagName").textContent =
        "@" +
  ...
  editButtons.forEach((editBtn) => {
    ...
    editBtn.addEventListener("click", (event) => {
      ...
      if (!active.editCommentActive) {
        ...
        const userElement =
          editTarget.parentNode.parentNode.querySelector(".user");
        editTarget.parentNode.parentNode.querySelector(
          ".comment-text"
        ).style.display = "none";
        editComment = editTemplate.cloneNode(true);
        const parentElement =
          editTarget.parentNode.parentNode.querySelector(".comment");
        ...
        editComment.querySelector("textArea").value =
          editTarget.parentNode.parentNode.querySelector(
            ".content"
          ).textContent;
      } else {
